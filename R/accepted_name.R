...
#'
setMethod(
  "accepted_name", signature(taxlist = "taxlist", ConceptID = "numeric"),
...
#'
setMethod(
  "accepted_name", signature(taxlist = "taxlist", ConceptID = "missing"),
  function(taxlist, ...) {
...
#'
setMethod(
  "synonyms", signature(taxlist = "taxlist", ConceptID = "numeric"),
  function(taxlist, ConceptID, ...) {
...
#'
setMethod(
  "synonyms", signature(taxlist = "taxlist", ConceptID = "missing"),
  function(taxlist, ...) {
    ConceptID <- taxlist@taxonRelations$TaxonConceptID
...
#'
setMethod(
  "basionym", signature(taxlist = "taxlist", ConceptID = "numeric"),
  function(taxlist, ConceptID, ...) {
...
#'
setMethod(
  "basionym", signature(taxlist = "taxlist", ConceptID = "missing"),
  function(taxlist, ...) {
    ConceptID <- taxlist@taxonRelations$TaxonConceptID
...
setReplaceMethod(
  "basionym", signature(
    taxlist = "taxlist", ConceptID = "numeric",
    value = "numeric"
  ),
  function(taxlist, ConceptID, value) {
    # first test
