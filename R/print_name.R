...
setMethod(
  ...
  function(object, id, concept = TRUE, second_mention = FALSE,
    ...
    if (concept & include_author & !missing(secundum) &
      ...
      View <- object@taxonViews[
        object@taxonViews$ViewID == View,
        secundum
      ]
