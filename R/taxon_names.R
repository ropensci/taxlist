...
#'
setMethod(
  "taxon_names", signature(taxlist = "taxlist"),
...
#'
setReplaceMethod("taxon_names", signature(
  taxlist = "taxlist",
  value = "data.frame"
...
#'
setMethod(
  "add_synonym", signature(taxlist = "taxlist"),
...
#'
setMethod(
  "update_name", signature(taxlist = "taxlist", UsageID = "numeric"),
  function(taxlist, UsageID, ...) {
...
#'
setMethod(
  "delete_name", signature(taxlist = "taxlist", UsageID = "numeric"),
  function(taxlist, UsageID, ...) {
