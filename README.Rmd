...
The aim of `taxlist` is to provide an object class for its implementation on
vegetation-plot data sets imported from [**Turboveg
...
[here](https://github.com/ropensci/software-review/issues/233#issuecomment-427814756)
