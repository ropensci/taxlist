...
The first one is installing from the repository at the **Comprehensive R Archive
Network**:
...
Since `taxlist` is developed on **GitHub**, it is also possible to install
last version from this repository using the package `devtools`:
