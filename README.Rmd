...
`` `r print_name(Easplist, 206)` ``, which will insert
...
`` `r print_name(Easplist, 206, second_mention=TRUE)` ``, which will insert
`r print_name(Easplist, 206, second_mention=TRUE)` in your text.
